# Generated by Django 5.1.15 on 2026-02-15 13:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_external', models.BooleanField(default=False, help_text='External user (e.g., freelancer, vendor)')),
                ('can_check_in', models.BooleanField(default=False)),
                ('can_check_out', models.BooleanField(default=False)),
                ('requires_confirmation', models.BooleanField(default=False, help_text='Operations by this user require confirmation from another user')),
